...
![시계열 트렌드]({{ site.url }}/assets/images/1_시계열_트렌드.png)

2022년부터 현재까지 ESG, 친환경, 탄소중립 키워드의 관심도 변화를 보여주는 시계열 차트다.

### 2. 기간별 평균 관심도 비교

![기간별 평균 관심도]({{ site.url }}/assets/images/2_기간별_평균_관심도.png)

초기 3개월, 중간 3개월, 최근 3개월로 나누어 각 키워드의 관심도 변화를 비교한 차트다.

### 3. 연령대별 관심도 분석

![연령대별 관심도]({{ site.url }}/assets/images/3_연령대별_관심도.png)

네이버 데이터랩을 활용하여 연령대별로 ESG 관련 키워드에 대한 관심도를 분석한 결과다.

### 4. 성별 관심도 분석

![성별 관심도]({{ site.url }}/assets/images/4_성별_관심도.png)

성별에 따른 ESG 키워드 관심도 차이를 보여주는 분석 결과다.

### 5. 연령-성별 히트맵

![연령성별 히트맵]({{ site.url }}/assets/images/5_연령성별_히트맵.png)

ESG 키워드에 대한 연령대와 성별을 교차 분석한 히트맵이다.

### 6. 키워드 간 상관관계

![키워드 상관관계]({{ site.url }}/assets/images/6_키워드_상관관계.png)
